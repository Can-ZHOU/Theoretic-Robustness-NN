...
import OtherMethods.lipMIP.utilities as utils
from OtherMethods.lipMIP.hyperbox import Hyperbox, LinfBallFactory, Domain
from OtherMethods.lipMIP.pre_activation_bounds import PreactivationBounds
import time
import pprint
import re
from OtherMethods.lipMIP.interval_analysis import HBoxIA
...
class LipProblem(utils.ParameterObject):
    ...
    def compute_max_lipschitz(self):
        """ Computes the maximum lipschitz constant with a fixed
            ...
            attains it
        """
        squire = self.build_gurobi_squire()
        timer = utils.Timer()
        model = squire.model
