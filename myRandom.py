...
def RomdomExperiment01(experimentIndex, inputSize):
    ...
    layer_sizes = [inputSize, inputSize, 2]
    ...
    print(results)
    ept.saveNetwork(folderName="MyRandom", networkName=str(experimentIndex))
    ept.storeExperiment(folderName="MyRandom")



###########################################################################################################
###########################################################################################################
RomdomExperiment01(experimentIndex = 10, inputSize = 4)
