...
int main() {
    ...
    float minGap = 1e-6;
    int max_boxes = 3000;
    vector<vector<int>> layer_sizes_list = {
        {4, 10, 2},
        {4, 10, 10, 2},
        {4, 10, 10, 10, 2},
        {4, 10, 10, 10, 10, 2},
        {4, 10, 10, 10, 10, 10, 2},
        {4, 10, 10, 10, 10, 10, 10, 2},
        {4, 10, 10, 10, 10, 10, 10, 10, 2},
        {4, 10, 10, 10, 10, 10, 10, 10, 10, 2},
        {4, 10, 10, 10, 10, 10, 10, 10, 10, 10, 2},
        {4, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 2}
    };

    for (int i = 0; i < 10; i++) {
        string file_index = to_string(i+1);
        string path = "parameters/MultiLayers/E" + file_index;
        vector<int> layer_sizes = layer_sizes_list[i];
